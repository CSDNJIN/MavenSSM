...
<body>
					...
					<c:forEach items="${lsst }" var="stu">
						<tr>
							...
							<td><a id="btn" href="del?ctid=${stu.ctid }"
								...
								<a id="upbtn" onclick="update(${stu.ctid})"
	...
	<div id="upd" align="center">
        <input id="ctid" value="" type="hidden"/>
		国家名称:<input id="ctname" value="" /> 国家星级:<input id="ctstar" value="" />
                 鸡肋:<input id="cid" value="" />
              <input type="button" onclick="updateGo()" value="修改"/>
	</div>
